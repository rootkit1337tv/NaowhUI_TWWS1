...
I.Installer = {
	...
	Pages = {
		[1] = function()
			...
			PluginInstallFrame.Desc2:SetText("To run the installation process again in order to update your profiles to their latest version or to reinstall NaowhUI, click on 'Continue'.\nTo skip the installation process and hide this frame, click on 'Skip Process'.")
			PluginInstallFrame.Option1:Show()
		...
		[9] = function()
			...
			PluginInstallFrame.Option1:Show()
			PluginInstallFrame.Option1:SetScript("OnClick", function() SE:Setup("WeakAuras") end)
